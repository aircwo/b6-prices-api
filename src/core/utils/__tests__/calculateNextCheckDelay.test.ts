...
describe("calculateNextCheckDelay", () => {
  ...
  test.each([
    {
      frequency: CheckFrequency.TEST,
      expectedDelay: 2 * 60 * 1000,
      description: "2 minutes for TEST frequency",
    },
    {
      frequency: CheckFrequency.HOURLY,
      expectedDelay: 60 * 60 * 1000,
      description: "1 hour for HOURLY frequency",
    },
    {
      frequency: CheckFrequency.DAILY,
      expectedDelay: 24 * 60 * 60 * 1000,
      description: "24 hours for DAILY frequency",
    },
    {
      frequency: "UNKNOWN" as CheckFrequency,
      expectedDelay: 24 * 60 * 60 * 1000,
      description: "default (24 hours) for unknown frequency",
    },
  ...
  test.each([
    {
      ...
      description:
        "8 AM today if current time is before 8 AM for MORNING frequency",
    },
    {
      frequency: CheckFrequency.MORNING,
      ...
      description:
        "8 AM tomorrow if current time is after 8 AM for MORNING frequency",
    },
    {
      ...
      description:
        "8 PM today if current time is before 8 PM for EVENING frequency",
    },
    {
      frequency: CheckFrequency.EVENING,
      ...
      description:
        "8 PM tomorrow if current time is after 8 PM for EVENING frequency",
    },
    {
    ...
    "should schedule for $description",
    ({ frequency, currentDate, targetDate }) => {
      // given
